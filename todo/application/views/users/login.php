            ...
            <h3>TODO List</h3>
                    ...
                    <form action="" method="post">
                        <div class="form-group">
                            <input type="email" name="email" class="form-control fadeIn second" placeholder="Email ID" id="login" >
                            <?php echo form_error('email','<p class="help-block alert alert-danger">','</p>'); ?>
                        </div>
                        <div class="form-group">
                            <input type="password" name="password" placeholder="Password" class="form-control fadeIn third" id="password">
